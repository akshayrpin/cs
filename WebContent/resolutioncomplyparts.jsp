...
<%
	...
	String redirecturl = Config.fullcontexturl()+"/resolutioncomplyparts.jsp?_id=0&_entid=0&_ent="+entity+"&_typeid="+typeid+"&_type="+type+"&_grpid="+groupid+"&_grp="+group+"&_grptype="+grouptype+"&_reload=true"; 
		...
		<div id="csuimain">
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">Permit Compliance - Comply All</td>
					</tr>
				</table>
				...
				<form class="form" action="action.jsp" method="post" success="<%=redirecturl%>">
					...
					<input type="hidden" name="_act" value="complyall">
