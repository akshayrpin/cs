...
<%
	...
	String redirecturl = Config.fullcontexturl()+"/resolutionexpireparts.jsp?_id=0&_entid=0&_ent="+entity+"&_typeid="+typeid+"&_type="+type+"&_grpid="+groupid+"&_grp="+group+"&_grptype="+grouptype+"&_reload=true"; 
		...
		<div id="csuimain">
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">Expire All Parts</td>
					</tr>
				</table>
				...
				<form class="form" action="action.jsp" method="post" success="<%=redirecturl%>">
					...
					<input type="hidden" name="_act" value="expire">

					<%= ObjTables.title(ftitle, "", "csui", alert, "", "", "", CsConfig.getImage("back"), new String[0], "","","","") %>
					<table class="csui" colnum="2" type="default">
						<tr>
							<td class="csui_label" id="label_DATE" valign="top">EXPIRATION DATE</td>
							<td class="csui vertical csui_field" id="field_DATE" valign="top">
								<input name="EXP_DATE" type="text" itype="date" value="">
							</td>
						</tr>
					</table>
					<br/>
