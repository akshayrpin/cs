...
<%
	...
	String complypartsurl = Config.fullcontexturl()+"/resolutioncomplyparts.jsp?_id=0&_entid=0&_ent=lso&_typeid="+typeid+"&_type="+type+"&_grpid="+groupid+"&_grp=resolution&_grptype=resolution"; 
	String appcomplypartsurl = Config.fullcontexturl()+"/resolutionappcomplyparts.jsp?_id=0&_entid=0&_ent=lso&_typeid="+typeid+"&_type="+type+"&_grpid="+groupid+"&_grp=resolution&_grptype=resolution"; 
	...
	if (Operator.toInt(groupid) < 1) {
		redirecturl = Config.fullcontexturl()+"/resolution.jsp?_id=0&_entid=0&_ent=lso&_typeid="+typeid+"&_type="+type+"&_grpid=data.id&_grp=resolution&_grptype=resolution&_code=data.messagecode"; 
	}


	String importurl = "";
	if (gvo.isAddable()) {
		importurl = ObjTables.getImportUrl(req, gvo);
	}
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				...
				<form class="form" action="action.jsp" method="post" success="<%=redirecturl%>" successalert="The resolution has been successfully saved.">
					...
					<%= ObjTables.title("RESOLUTION", "", "csui", alert, "", "", "", "", importurl, ObjTables.WHITEIMPORTIMGURL, new String[0], "","","","") %>
					<table class="csui" colnum="2" type="default">
						...
						if (type.equalsIgnoreCase("project") || type.equalsIgnoreCase("activity")) {
							t = "temporary";
							tc = "permanent,temporary";
						}

						if (Operator.toInt(groupid) < 1) {
							out.print("<tr>");
							out.print(ObjTables.cells("RESOLUTION_NUMBER", "NUMBER", rvo.getNumber(), "String", "text", true, "csui", editgroup));
							out.print(ObjTables.cells("PART", "PART", "", "String", "text", true, "csui", true));
							out.print("</tr>");
							out.print("<tr>");
							out.print(ObjTables.cells("STATUS_ID", "STATUS", "", "String", "text", true, "csui", 1, status, false, true));
							out.print(ObjTables.cells("DATE", "DATE", d.getString("YYYY/MM/DD"), "date", "date", true, "csui", true));
							out.print("</tr>");
							out.print("<tr>");
							out.print(ObjTables.cells("TITLE", "TITLE", rvo.getTitle(), "String", "text", true, "csui", editgroup));
							out.print(ObjTables.cells("TYPE", "TYPE", t, "String", "text", true, "csui", tc, false, true));
							out.print("</tr>");
							out.print("<tr>");
							out.print(ObjTables.cells("PART_TITLE", "PART TITLE", "", "String", "largetext", true, "csui", true));
							out.print("</tr>");
							out.print("<tr>");
							out.print(ObjTables.cells("DESCRIPTION", "DESCRIPTION", "", "String", "largetextarea", true, "csui", true));
							out.print("</tr>");
						}
						else {
							out.print("<tr>");
				   ...
				   <tr>
				     ...
				     <% if (rvo.isAdopted()) {  %>
					     <td class="csui_controls" style="padding-right: 15px;">
					       <a href="<%=appcomplypartsurl %>" class="csui_controls" title="Application Compliance" target="lightbox-iframe"><img src="<%= ObjTables.WHITECOMPLETEIMGURL %>" width="20" height="20" border="0"/></a>
					     </td>
					     <td class="csui_controls" style="padding-right: 15px;">
					       <a href="<%=complypartsurl %>" class="csui_controls" title="Permit Compliance" target="lightbox-iframe"><img src="<%= ObjTables.WHITECOMPLETEIMGURL %>" width="20" height="20" border="0"/></a>
					     </td>
				     <% } %>
				     <td class="csui_controls" style="padding-right: 15px;">
				       <a href="<%=multiurl %>" class="csui_controls" title="Edit All Parts" target="lightbox-iframe"><img src="<%= ObjTables.WHITEMULTIEDITIMGURL %>" width="20" height="20" border="0"/></a>
				     </td>
				     <td class="csui_controls" style="padding-right: 15px;">
				     ...
				     <td class="csui_controls" style="padding-right: 15px;">
				       <a href="<%= addparturl %>" class="csui_controls" title="Add New Part" target="lightbox-iframe"><img src="<%= ObjTables.WHITEADDIMGURL %>" width="20" height="20" border="0" id="addparttoggle" style="cursor: pointer"/></a>
				     </td>
				   </tr>
				 </table>
