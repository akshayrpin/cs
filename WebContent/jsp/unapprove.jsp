		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">REJECT</td>
				...
				<form id="csform" class="form" action="/cs/action.jsp" method="post" close="true" refresh="true">
					...
					<input type="hidden" name="_request" value="unapprove">
					<input type="hidden" name="_action" value="onlineapproval">
					
					<table class="csui_title">
						<tr>
							<td class="csui_title">COMMENT</td>
						...
						<table class="csui" colnum="2" type="default">
							<tr>
								...
								<td class="csui" valign="top">
									<select name="status" id="status" itype="String"  _ent="parking"  valrequired="true" json="<%=CsConfig.getString("dropdownlist.applicationstatus")%>"></select>
								</td>
								<td class="csui_label" colnum="2" alert="">COMMENT</td>
								<td class="csui" colnum="2" type="String" itype="text" alert=""><textarea name="comment" itype="textarea" ></textarea></td>
							</tr>
					</table>
