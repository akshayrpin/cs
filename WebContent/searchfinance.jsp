...
String solrurl = CsConfig.getString("search.finance");
...
String bookurl = "";
%>
<%@include file="search/gsfacetfinance.jsp"%>
...
// 			  },
	...
	$(document).ready(function() {
	 ...
	 function openexport(){
		 var url = "exportcsv.jsp?method=csv&source=finance&q=";
	 	 url += $('#sq').val();	 url += "&wt=csv"; url += "&defType=edismax"; url += "&mm=100"; url += "&_facet="+facets; url += "&start=0"; url += "&rows=5000000"; 
	 	 url += "&_fq="+$('#sffq').val();
	 	 //url += "&expfl=id,method,paymentcounter,transactiontype,payment_amount,comment,online,online_trans_id,account_no,created_date,updated_date,payment_date,payment_amount,payee,cashier,payment_date_only";
		...
		$.ajax({
			  ...
			  data: { 
				...
				// qf:"act_nbr",
				 ...
				 _location : "searchfinance",
				 fl:"id,method,paymentcounter,transactiontype,payment_amount,comment,online,online_trans_id,account_no,created_date,updated_date,payment_date,payment_amount,payee,cashier,payment_date_only",
				 _url:"<%=solrurl%>"
			     // valuation : valuation,
			      //mode : mode
			    },
...
function statistics(facets,fq,filters){
	...
	function updatestats(output){
		output = JSON.stringify(output);
 		...
 		var st1 = st['payment_amount'];
 		var lt = st1.sum;
 		var d = 'Paid Total: $'+lt.formatMoney(2, '.', ',')+'';
		...
		output = JSON.stringify(output);
 		...
 		$.each(high, function(k,v) {
 			...
 			if(v.id!=''){
					...
					c += '<td class="csui" type="String" itype="String"><a class="csui" href="'+l+'" target="_blank" ><p>'+k+' <br>';
	 		...
	 		$.each(resp['docs'], function(k,v) {
	 			...
	 			if(v.id!=''){
						...
						//c += '<td class="csuisub" type="String" itype="String"><a class="csui" href="'+l+'" >'+t+'</a></td>';
				 		...
				 		c += '<td class="csui" type="String" itype="String"><a class="csui" href="'+l+'" target="_blank" >'+v.id+'</a></td>';
				 		c += '<td class="csui" type="String" itype="String"><a class="csui" href="'+l+'" target="_blank"  >'+method+'</a></td>';
				 		c += '<td class="csui" type="String" itype="String"><a class="csui" href="'+l+'" target="_blank"  >'+transactiontype+'</a></td>';
				 		c += '<td class="csui" type="String" itype="String">';
				 		if(v.payment_amount>0 || v.payment_amount<=0){
				 			c += '$'+v.payment_amount.formatMoney(2, '.', ',')+'';
				 		}
				 		c += '&nbsp;</td>';
				 		c += '<td class="csui" type="String" itype="String"><a class="csui" href="'+l+'" target="_blank"  >'+ref_nbr+'</a></td>';
				 		c += '<td class="csui" type="String" itype="String"><a class="csui" href="'+l+'" target="_blank"  >'+payment_date_only+'</a></td>';
				 		c += '<td class="csui" type="String" itype="String"><a class="csui" href="'+l+'" target="_blank"  >'+cashier+'</a></td>';
				 		c += '<td class="csui" type="String" itype="String"><a class="csui" href="'+l+'" target="_blank"  >'+payee+'</a></td>';
				 		c += '<td class="csui" type="String" itype="String"><a class="csui" href="'+l+'" target="_blank"  >&nbsp;</a></td>';
					...
					<tr>
						<td class="csui" colnum="2" type="String" itype="String" alert="">
							<select  class="chosen" id="display_type" name="display_type" itype="String" val="" _ent="lso" valrequired="false" >
								...
								<option value="searchfinance.jsp?sq=<%=q%>"  selected="selected" >FINANCE</option>	
						...
						<table class="csui" type="horizontal" id="tablesort">
							<thead>
						 		<tr>
							 		...
							 		<td class="csui_header sort" type="String" itype="String" title="Sort" style="cursor:pointer;" sort="method" sorttype="asc" >METHOD</td>
							 		<td class="csui_header sort" type="String" itype="String" title="Sort" style="cursor:pointer;" sort="transactiontype" sorttype="asc" >TRANSACTIONTYPE</td>
							 		<td class="csui_header sort" type="String" itype="String" title="Sort" style="cursor:pointer;" sort="payment_amount" sorttype="asc" >AMOUNT</td>
							 		<td class="csui_header sort" type="String" itype="String" title="Sort" style="cursor:pointer;" sort="account_no" sorttype="asc" >REFERENCE</td>
							 		<td class="csui_header sort" type="String" itype="String" title="Sort" style="cursor:pointer;" sort="payment_date_only" sorttype="asc" >DATE</td>
