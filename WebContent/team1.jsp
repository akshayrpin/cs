	...
	<div id="csuibody">
		<div id="csuimain">
			...
			<div class="csuicontent">
				<br/>
				<form method="post" action="team.jsp" id="teamsearch">
					<table cellpadding="5" cellspacing="0" border="0" width="100%" align="center">
						<tr>
							<td class="csui_defaulttitle" width="1%" nowrap>Search Team</td>
							<td width="99%">
						...
						<td width="50%" valign="top">
							<div id="div_choices" style="border-left: 1px solid #cccccc; padding-left: 20px">
								<form method="post" action="action.jsp" id="peoplesubmit">
									...
									<input type="hidden" name="<%= RequestMapper.groupid %>" value="people"/>
