...
String solrurl = CsConfig.getString("search.address");
...
String bookurl = "";
%>
<%@include file="search/gsfacetaddress.jsp" %>
...
// 			  },
	...
	$(document).ready(function() {
	 ...
	 function openexport(){
		 var url = "exportcsv.jsp?method=csv&source=activity&q=";
	 	 ...
	 	 url += "&_fq="+$('#sffq').val();
	 	 //url += "&expfl=lso_id,address,lsodescription,lso_type,apn,latitude,longitude,primary,divisions";
		...
		$.ajax({
			  ...
			  data: { 
				...
				// qf:"act_nbr",
				 ...
				 _location : "searchlso",
				 fl:"lso_id,address,lsodescription,lso_type,apn,latitude,longitude,primary",	
				 _url:"<%=solrurl%>"
			     // valuation : valuation,
			      //mode : mode
			    },
	...
	function displayresults(output){
		output = JSON.stringify(output);
 		...
 		var u = "<%=Config.fullcontexturl() %>/?entity=lso&type=lso&typeid=";
 		var ul = "<%=Config.fullcontexturl() %>/?entity=lso&type=lso&typeid=";
 		...
 		$.each(high, function(k,v) {
	 		...
	 		$.each(resp['docs'], function(k,v) {
	 			...
	 			if(v.id!=''){
 					...
 					var lat ="";
 					var lon="";
 					if(v.lsodescription==undefined){ description ="";} else {description=v.lsodescription; }
 					...
 					if(v.lso_type==undefined){ type ="";} else {type=v.lso_type; }
					...
					c += '<td class="csui" type="String" itype="String"><input type="checkbox" name="ID"  class="inspresults" value="'+v.id+'" act_id="'+v.lso_id+'"  /> </td>';
			 		c += '<td class="csui" type="String" itype="String"><a class="csui" href="'+l+'" target="_top"  >'+title+'</a></td>';
			 		c += '<td class="csui" type="String" itype="String"><a class="csui" href="'+l+'" target="_top"  >'+type+'</a></td>';
			 		c += '<td class="csui" type="String" itype="String"><a class="csui" href="'+l+'" target="_top"  >'+address+'</a></td>';
			 		c += '<td class="csui" type="String" itype="String"><a class="csui" href="'+l+'" target="_top"  >'+apn+'</a></td>';
			 		c += '<td class="csui" type="String" itype="String"><a class="csui" href="'+l+'" target="_top"  >'+description+'</a></td>';
			 		c += '<td class="csui" type="String" itype="String"><a class="csui" href="'+l+'" target="_top"  >'+lat+'</a></td>';
			 		c += '<td class="csui" type="String" itype="String"><a class="csui" href="'+l+'" target="_top"  >'+lon+'</a></td>';
			 		c += '</tr>';
...
//	 			c +='</div> ';
	...
	function printall(){
		 var v = $('input:checkbox.inspresults:checked').map(function() {    return $(this).attr('act_id'); }).get();
			if(v==""){
				swal("Select lso in order to proceed");
				return false;
			}
	...
	<div id="csuibody">
		<div id="csuisub">
					...
					<tr>
						<td class="csui" colnum="2" type="String" itype="String" alert="">
							<select  class="chosen" id="display_type" name="display_type" itype="String" val="" _ent="lso" valrequired="false" >
								...
								<option value="searchlso.jsp?sq=<%=q%>" selected="selected">ADDRESS</option>	
				...
				<table cellpadding="5" cellspacing="2" width="100%">
					...
					<tr>
						<td width="50%" class="cssearch_currency"><input type="text" class="cssearch" itype="integer"  id="amount_st" name="amount_st" value="" ftype="amount" placeholder="0.00"> </td>
						<td width="50%" class="cssearch_currency"><input type="text" class="cssearch" itype="integer" id="amount_ed" name="amount_ed" value="" ftype="amount" placeholder="0.00">	</td>
					</tr> 
					...
					<tr>
						<td width="50%" class="cssearch_currency"><input type="text" class="cssearch" itype="integer"  id="paid_st" name="paid_st" value="" ftype="paid" placeholder="0.00"> </td>
						<td width="50%" class="cssearch_currency"><input type="text" class="cssearch" itype="integer" id="paid_ed" name="paid_ed" value="" ftype="paid" placeholder="0.00">	</td>
					</tr> 
					<tr>
						<td colspan="2" class="csuisub_title">BALANCE DUE </td>
					</tr>
					<tr>
						<td width="50%" class="cssearch_currency"><input type="text" class="cssearch" itype="integer"  id="balance_st" name="balance_st" value="" ftype="balance" placeholder="0.00"> </td>
						<td width="50%" class="cssearch_currency"><input type="text" class="cssearch" itype="integer" id="balance_ed" name="balance_ed" value="" ftype="balance" placeholder="0.00">	</td>
					</tr> 
						...
						<table class="csui" type="horizontal" id="tablesort">
							<thead>
						 		<tr>
							 		...
							 		<td class="csui_header sort" type="String" itype="String" title="Sort" style="cursor:pointer;" sort="lso_id" sorttype="asc" >LSO ID </td>
							 		<td class="csui_header sort" type="String" itype="String" title="Sort" style="cursor:pointer;" sort="lso_type" sorttype="asc" >TYPE</td>
							 		...
							 		<td class="csui_header sort" type="String" itype="String" title="Sort" style="cursor:pointer;" sort="lsodescription" sorttype="asc" >DESC</td>
							 		<td class="csui_header sort" type="String" itype="String" title="Sort" style="cursor:pointer;" sort="latitude" sorttype="asc" >LAT</td>
							 		<td class="csui_header sort" type="String" itype="String" title="Sort" style="cursor:pointer;" sort="longitude" sorttype="asc" >LON</td>
						 		</tr>
 							</thead>
