...
RequestVO activityreq = req.duplicate();
activityreq.setRequest("activities");
SubObjVO[] activities = ApiHandler.getChoices(activityreq);
...
//	 			c +='</div> ';
	...
	<style>
		...
		.activities tr:nth-child(even) {background: #eeeeee}
		.activities tr:nth-child(odd) {background: #ffffff}
				 						...
				 						<td width="50%" valign="top">
											...
											<div id="div_choices" style="border-left: 1px solid #cccccc; padding-left: 20px">
												<form class="form" method="post" action="action.jsp" id="peoplesubmit" success="<%=req.summaryUrl()%>">
													...
													<br/><br/>
													<table cellpadding="5" cellspacing="0" border="0" width="90%" class="activities">
														<tr>
															<td colspan="3" class="csui_defaulttitle">ADD TO ACTIVITIES</td>
														</tr>
														<tr>
															<td class="csui_header" width="1%" nowrap>&nbsp;</td>
															<td class="csui_header" width="1%" nowrap>Activity Number</td>
															<td class="csui_header">Type</td>
														</tr>
														<%
															for (int i=0; i<activities.length; i++) {
																SubObjVO act = activities[i];
																out.print("<tr>");
																out.print("<td width=\"1%\" nowrap><input type=\"checkbox\" name=\"ACTIVITIES\" value=\""+act.getId()+"\"/></td>");
																out.print("<td class=\"people_result\" width=\"1%\" nowrap>"+act.getText()+"</td>");
																out.print("<td class=\"people_result\">"+act.getDescription()+"</td>");
																out.print("</tr>");
															}
														%>
													</table>
													...
													<input type="hidden" name="<%= RequestMapper.group %>" value="peoplesummary"/>
													<input type="hidden" name="<%= RequestMapper.grouptype %>" value="peoplesummary"/>
												</form>
											</div>
