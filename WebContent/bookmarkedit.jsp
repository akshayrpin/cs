...
<%
	...
	if(map.equalsIgnoreCase("action", "update")){
		result = GlobalSearch.bookmarkEdit(map);
	}
	...
	<div id="csuibody">
		<div id="csuimain">
			...
			<div class="csuicontent">
				...
				<form class="form" action="bookmarkedit.jsp" method="post" ajax="no" >
					...
					<div class="csui_buttons">
						<input type="submit" name="action" value="Update" class="csui_button">
					</div>
