...
String solrurl = CsConfig.getString("search.user");
...
<style>
	...
	function selectResult(pid) {
	 	...
	 	selectUser(pid, pname, pemail, pusername, pgroup, paddress, plic, ptype);
	}

	function selectUser(pid, pname, pemail, pusername, pgroup, paddress, plic, ptype) {
		...
		output = JSON.stringify(output);
 		...
 		$.each(resp['docs'], function(k,v) {
 			...
 			if(v.id!=''){
					...
					if (hasValue(eml) && eml.toLowerCase() != username.toLowerCase()) {
						...
						<td align="left">
							<table class="csui_tools" width="100%">
								<tr>
									...
									<td align="right">
										<a href="<%= Config.fullcontexturl() %>/selectuser.jsp?_ent=<%= entity %>&_type=<%= type %>&_typeid=<%= typeid %>&_grptype=people"><img src="<%= ObjTables.WHITEADDIMGURL %>" height="25" width="25" border="0"/></a>&nbsp;&nbsp;
									</td>
								</tr>
							</table>
						</td>
						...
						<div class="csuicontent">
							...
							<div id="cssearch_results">
								...
								<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
									<tr>
										<td class="csui">		
											<table cellpadding="5" cellspacing="0" border="0" align="center" id="resultsadd">
											</table>
				 						</td>
	 								</tr>
								</table>	
