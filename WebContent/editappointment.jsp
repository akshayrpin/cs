...
<%
	...
	SubObjVO[] collaborators = ApiHandler.getChoices(creq);
 	...
 	ntreq.setGrouptype("appointment");
	...
	<div id="csuibody">
		<div id="csuimain">
			<div class="csuicontent">
				...
				<form id="csform" class="form" action="action.jsp" method="post" close="true">
					...
					<table class="csui" type="default">
						...
						<tr>
							...
							<td class="csui vertical csui_field" type="people" itype="people" valign="top">
						...
						<tr>
							<td class="csui_label">NOTE</td>
							<td class="csui vertical csui_field" type="textare" itype="notes" colspan="3">
