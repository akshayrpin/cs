		...
		var _ = {
			bindHandlers: function(){
				...
				$CheckboxContainer.on("mousedown.MobileCheckbox touchstart.MobileCheckbox", function(e){
					...
					return $(document).on("mouseup.MobileCheckbox touchend.MobileCheckbox", function(e){
						e.preventDefault();
						...
						return $(document).off("mouseup.MobileCheckbox touchend.MobileCheckbox");
					});
				});
			...
			makeCheckbox: function(){
				...
				$("<div/>", {
					...
					css: {
						...
						boxShadow: "inset 0px "+Math.floor(checkboxHeight/3)+"px 0px 4px rgba(0, 0, 0, 0.02), inset 3px 3px 15px -3px rgba(0, 0, 0, 0.2)"
					}
				}).appendTo($CheckboxContainer);
