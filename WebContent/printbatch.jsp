...
<html>
	<head>
		...
		function doClose(response) {
			parent.showProgress(response);
							 ...
							 <tbody>
								...
								<tr id="tr_">
									...
									<td class="csui" width="1%">
										<a  href="email.jsp?_ent=<%=map.getString("_ent") %>&_entid=-1&_type=<%=type %>&_typeid=<%=typeIds %>&_id=<%=ids %>&_grptype=email&_act=email&_reference=<%=entry.getKey() %>" title="E-mail" border="0"  target="lightbox-iframe"  ><img src="/cs/images/icons/controls/black/email.png" border="0"></a>
									</td>
									<td class="csui" width="1%">
										<%-- <a  href="print.jsp?_ent=<%=map.getString("_ent") %>&_entid=-1&_type=<%=type %>&_typeid=<%=typeIds %>&_grp=<%=grp %>&_grpid=<%=grpid %>&_id=<%=ids %>&_grptype=print&_act=print&_reference=<%=entry.getKey() %>&subrequest=<%=subrequest%>" title="Print" border="0"  target="_blank" onclick="close();" ><img src="/cs/images/icons/controls/black/print.png" border="0"></a> --%>
										<a  href="javascript:void(0);" title="Print" border="0"  onclick="closelightframe('<%= Config.fullcontexturl() %>/print.jsp?_ent=<%=map.getString("_ent") %>&_entid=-1&_type=<%=type %>&_typeid=<%=typeIds %>&_grp=<%=grp %>&_grpid=<%=grpid %>&_id=<%=ids %>&_grptype=print&_act=print&_reference=<%=entry.getKey() %>&subrequest=<%=subrequest%>&_ref=<%=ref%>');" ><img src="/cs/images/icons/controls/black/print.png" border="0"></a>
									</td>
