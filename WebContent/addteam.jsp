...
<title>City Smart- V1</title>
	...
	<script>
		function addToParent(value, text) {
			parent.addPeople('team','<%=fieldid%>', value, text);
...
<body>
	...
	<form method="post" action="addteam.jsp">
	...
	<%
		for (int i=0; i<l; i++) {
			...
			out.print("<a class=\"lightbox-iframe\" href=\"#\" onclick=\"addToParent('"+Operator.javascriptFriendly(vo.getValue())+"','"+Operator.javascriptFriendly(vo.getText())+"')\"><img src=\"" + CsConfig.getImage("black", "add") + "\"/></a>");
