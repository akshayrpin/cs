...
<%
	...
	String redirecturl = Config.fullcontexturl()+"/resolutionmulti.jsp?_id=0&_entid=0&_ent="+entity+"&_typeid="+typeid+"&_type="+type+"&_grpid="+groupid+"&_grp="+group+"&_grptype="+grouptype+"&_reload=true"; 
		...
		<div id="csuimain">
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">Edit All Parts</td>
					</tr>
				</table>
				...
				<form class="form" action="action.jsp" method="post" success="<%=redirecturl%>">
					...
					<input type="hidden" name="_act" value="multiedit">

					<%= ObjTables.title(ftitle, "", "csui", alert, "", "", "", CsConfig.getImage("back"), new String[0], "","","","") %>
					<table class="csui" colnum="2" type="default">
						<tr>
							<td class="csui_label" id="label_DATE" valign="top">RESOLUTION DATE</td>
							<td class="csui vertical csui_field" id="field_DATE" valign="top">
								<input name="DATE" type="text" itype="date" value="" class="required">
							</td>
						</tr>
						<tr>
							<td class="csui_label" id="label_STATUS_ID" valign="top">STATUS</td>
							<td class="csui vertical csui_field" id="field_STATUS_ID" valign="top">
								<select name="STATUS_ID" itype="text" val="" class="required">
									<option value=""></option>
									<%
										for (int i=0; i<status.length; i++) {
											SubObjVO typ = status[i];
											...
											for (Map.Entry<String,String> entry : addldata.entrySet()) {
												...
												out.print(f);
												out.print("=\"");
												out.print(Operator.formFriendly(v));
												out.print("\" ");
											}
	
											out.print(">");
											out.print(typ.getText());
											out.print("</option>");
										}
									%>
								</select>
					...
					<table width="100%">
						<tr>
							<td width="98%">&nbsp;</td>
							<td width="1%" nowrap class="common" align="right">Apply this edit only to the parts related to this <%= type %> level.</td>
							<td width="1%" nowrap><input type="radio" name="APPLY_TO_ALL" value="N" checked/></td>
						</tr>
						<tr>
							<td width="98%">&nbsp;</td>
							<td width="1%" nowrap class="common" align="right">Apply this edit to all parts of resolution number <%= rvo.getNumber() %>.</td>
							<td width="1%" nowrap><input type="radio" name="APPLY_TO_ALL" value="Y"/></td>
						</tr>
					</table>
					<br/>
